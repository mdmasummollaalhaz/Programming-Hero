...
1. template string ${}
2. spread (...)
2.1 copy and array then add a new element to an array
2.2 use filter to remove an element from an array
3. Arrow function
3.1 no parameter - ()
3.2 singla parameter
3.3 multiple parameters ()
3.4 multi line
4. destructuring: object destructuring array destructiong
5. object shorthand
